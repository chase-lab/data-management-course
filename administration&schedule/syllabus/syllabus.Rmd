...
- Basics for dealing with spatial data: 
* Geographic coordinate systems 
* Projections and transformations 
* Tools to handle spatial data: e.g., a GIS (for visualization and map production) or R (for analysis). 
- Example of plot data transformation: from an unusual coordinate system to a standard reference system WGS84. 

## Introduction to database (Roel)
 - what is a relational database?
 - why?
 - Structure? fore reliability, for readability, reproducibility, archiving, FAIR, speed, weight

## Version control (Ani, Alban)
...
## Workflow (Alban)
 ...
 - Using (or not using...) DropBox for you analyses.
